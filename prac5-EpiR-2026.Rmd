...
```{r p5_1, eval=TRUE,echo=TRUE,warning=FALSE}
library(Epi)
data( thoro )
str( thoro )
```
...
```{r p5_2, eval=TRUE,echo=TRUE,warning=FALSE}
head( thoro )
thoro$birthdat[1:6]
...
```{r p5_3, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_4, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_5, eval=TRUE,echo=TRUE,warning=FALSE}
par(mfrow=c(1,2))
...
```{r p5_6, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_7, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_8, eval=TRUE,echo=TRUE,warning=FALSE}
data(gmortDK)
...
```{r p5_9, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_10, eval=TRUE,echo=TRUE,warning=FALSE}
thL.ap[thL.ap$id==1, ]
```
...
```{r p5_11, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_12, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_13, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_14, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_15, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p5_16, eval=TRUE,echo=TRUE,warning=FALSE}
