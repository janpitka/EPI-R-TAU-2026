...
```{r p6_1, eval=T,echo=FALSE,warning=FALSE}
library(data.table)
...
```{r p6_2, eval=TRUE,echo=FALSE,warning=FALSE}
...
```{r p6_3,echo=TRUE,warning=FALSE}
...
```{r p6_4, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_5, eval=TRUE,echo=TRUE,warning=FALSE}
str(mm) ; summary(mm)
```
...
```{r p6_6, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_7, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_8, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_9, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_10, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_11, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_12, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_13, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_14, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_15, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_16, eval=TRUE,echo=TRUE,warning=FALSE}
library(Epi)
library(survival)
data(diet)
head(diet)
...
```{r p6_16b, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_17, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_18, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_19, eval=TRUE,echo=TRUE,warning=FALSE}
## Load data
data(nwtco)
head(nwtco)
```
...
```{r p6_20, eval=TRUE,echo=TRUE,warning=FALSE}
...
```{r p6_21, eval=TRUE,echo=TRUE,warning=FALSE}
